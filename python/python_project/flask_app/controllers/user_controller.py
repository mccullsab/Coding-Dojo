...
def user_display():
    ...
    # blog_instances = Blog.get_all_one_user(data)
    destination_instances = Destination.get_all_one_user(data)
    return render_template("dashboard.html", destination_instances=destination_instances, logged_user=logged_user)
